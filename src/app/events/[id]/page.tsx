...
export default function EventDetailPage() {
  ...
  const [feedbackData, setFeedbackData] = useState({ rating: 5, comment: '', wouldRecommend: true });
  ...
  const handleSubmitFeedback = async () => {
    ...
    try {
      await clientApi.submitEventFeedback(token, id, feedbackData);
      showToast('Fikr-mulohazangiz uchun rahmat!', 'success');
    ...
    <Container className="py-8">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          ...
          {/* Event Feedback Form - only for past events */}
          {isEventPast() && (
            <div className="mt-8">
              <Card>
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900">Tadbir haqida fikr-mulohaza</h2>
                    <p className="text-gray-600 mt-1">
                      Tadbirni yaxshilash uchun fikringizni bildiring
                    </p>
                  </div>
                  {!showFeedbackForm && (
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          placeholder="Tadbir haqida fikringizni yozing..."
                        />
                      </div>
                      ...
                      <div>
                        <label className="flex items-center gap-3 cursor-pointer">
                          ...
                          <span className="text-sm text-gray-700">
                            Bu tadbirni boshqalarga tavsiya qilaman
                          </span>
                        </label>
                      </div>
